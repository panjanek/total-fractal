...
/// uniform block in solve.comp exactly: 4x vec4 + 3x ivec4 = 112 bytes. std140 places each
...
public struct SolveConfig
{
    ...
    public Vector4i Iter;  // x = iterations; y,z,w reserved
    public Vector4i Flags; // x = plotAll (0/1); y,z,w reserved
}
